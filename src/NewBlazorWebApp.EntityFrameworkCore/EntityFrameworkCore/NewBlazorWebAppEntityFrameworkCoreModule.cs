...
public class NewBlazorWebAppEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<NewBlazorWebAppDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also NewBlazorWebAppDbContextFactory for EF Core tooling. */
