...
using NewBlazorWebApp.Blazor.Client;
using NewBlazorWebApp.Blazor.Components;
using Volo.Abp;
...
[DependsOn(
    ...
    typeof(NewBlazorWebAppHttpApiModule),
...
public class NewBlazorWebAppBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(NewBlazorWebAppResource),
                typeof(NewBlazorWebAppDomainModule).Assembly,
                typeof(NewBlazorWebAppDomainSharedModule).Assembly,
                typeof(NewBlazorWebAppApplicationModule).Assembly,
                typeof(NewBlazorWebAppApplicationContractsModule).Assembly,
                typeof(NewBlazorWebAppBlazorModule).Assembly
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("NewBlazorWebApp");
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/NewBlazorWebApp.Blazor.styles.css", true));
                    bundle.AddFiles(new BundleFile("/NewBlazorWebApp.Blazor.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<NewBlazorWebAppDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}NewBlazorWebApp.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<NewBlazorWebAppDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}NewBlazorWebApp.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<NewBlazorWebAppApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}NewBlazorWebApp.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<NewBlazorWebAppApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}NewBlazorWebApp.Application"));
                options.FileSets.ReplaceEmbeddedByPhysical<NewBlazorWebAppBlazorModule>(hostingEnvironment.ContentRootPath);
            });
        }
    }
    ...
    private void ConfigureSwaggerServices(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "NewBlazorWebApp API", Version = "v1" });
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(NewBlazorWebAppBlazorModule).Assembly;
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(NewBlazorWebAppApplicationModule).Assembly);
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<NewBlazorWebAppBlazorModule>();
        });
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "NewBlazorWebApp API");
        });
        app.UseAuditing();
