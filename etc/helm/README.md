...
```
127.0.0.1 newblazorwebapp-local-web
127.0.0.1 newblazorwebapp-local-webgateway
127.0.0.1 newblazorwebapp-local-authserver
```
...
Now, you can browse the URL: `https://newblazorwebapp-local-web`
